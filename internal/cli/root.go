...
func init() {
	...
	register("pbs", "Inspect Proxmox Backup Server", nil,
		...
		&command{name: "subscription", short: "Show PBS subscription status", run: runPBSSubscription},
		&command{name: "certificates", short: "List PBS certificates", run: runPBSCertificates},
		&command{name: "datastore", short: "Inspect PBS datastores", run: runPBSDatastoreDispatch},
		&command{name: "snapshot", short: "Inspect PBS backup snapshots", run: runPBSSnapshotDispatch},
		&command{name: "task", short: "Inspect PBS tasks", run: runPBSTaskDispatch},
		&command{name: "verify", short: "Inspect PBS verification jobs", run: runPBSVerifyDispatch},
		&command{name: "prune", short: "Inspect PBS prune jobs", run: runPBSPruneDispatch},
