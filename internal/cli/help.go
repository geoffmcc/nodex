...
var leafHelp = map[string]helpEntry{
	...
	"firewall cluster-rules":       {usage: "", desc: "List cluster-wide firewall rules (/cluster/firewall/rules)"},
	"firewall list":                {usage: "", desc: "List cluster-wide firewall rules (alias for cluster-rules)"},
	"firewall rules":               {usage: "", desc: "List cluster-wide firewall rules (alias for cluster-rules)"},
	...
	"firewall security-group create": {desc: "Create a firewall security group", usage: "<name> [--comment \"...\"]"},
	"firewall security-group delete": {desc: "Delete a firewall security group", usage: "<name>"},
